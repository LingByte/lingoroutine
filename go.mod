module github.com/LingByte/lingoroutine

go 1.25.6

require (
	github.com/LingByte/LingStorage v0.0.0-20260227072542-5c91321a96ce
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/vod v1.3.75
